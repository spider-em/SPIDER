...
C     GET RECORD INFO
      ...
      PRINT *, __FILE__," : 1676: LUNSAYINFO: USE_SPIRE=",USE_SPIRE
      PRINT *, __FILE__," : 1677: LUNSAYINFO: DSP=",DSP
...
C         PRINT STACK OPENING INFORMATION
          PRINT *, __FILE__," : 1715: LUNSAYINFO: LENTIT=",LENTIT
          PRINT *, __FILE__," : 1716: LUNSAYINFO: NLET=",NLET
...
C           FILENAME AND TITLE DO NOT FIT ON SINGLE LINE
         ...
         PRINT *, __FILE__," : 1745: LUNSAYINFO: ISTACK=",ISTACK
         PRINT *, __FILE__," : 1746: LUNSAYINFO: IMGNUM=",IMGNUM
         IF (ISTACK .NE. 0 .AND. IMGNUM == 0 .AND. NZ > 1)THEN
