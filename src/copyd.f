...
C       PRINT *, __FILE__," : 137: COPYD: FLIPOUT=",FLIPOUT
        IF (FLIPOUT) THEN
...
C       OPEN FIRST OUTPUT FILE
        IMG2 = IMG1
C       PRINT *, __FILE__," : 147: Calling OPFILES, FILNAM1=",FILNAM1
C       PRINT *, __FILE__," : 148: Calling OPFILES, FILNAM2=",FILNAM2
     ...
     &             NDUM,NGOT2,IMG2, IRTFLG) 
        ...
        IF (FLIPOUT) THEN
C          STANDARD COPY WITH FLIPPED ENDEDNESS
C          PRINT *, __FILE__," : 160: COPYD: Calling LUNGETFLIP"
           CALL LUNGETFLIP(LUN1,IFLIPIN,IRTFLG)
           IF (IFLIPIN .NE. 1) IFLIPOUT = 1
        ENDIF
...
C          PRINT *, __FILE__," : 168: COPYD: Calling LUNSETFLIP"
...
C          PRINT *, __FILE__," : 189: COPYD: FILNAM1=",FILNAM1
C          PRINT *, __FILE__," : 190: COPYD: FILNAM2=",FILNAM2
